...
import { visibleNav } from "./navItems.ts";
...
// NAV and the gating rule live in navItems.ts, where they can be tested.
...
export function NavRail({ view, onView, inRoom, hasCampaigns, hasGalaxy, activeGame }) {
  const items = visibleNav({ game: activeGame, hasCampaigns, hasGalaxy, view });
  return (
...
export default function AppShell({ view, onView, inRoom, connection, users, engine, game, onReconnect, attempt, children, overlay,
  version, updateReady, inbox, skin, hasCampaigns, hasGalaxy, activeGame }) {
    ...
    <div style={{ position: "relative", display: "flex", flexDirection: "column", height: "100%",
      ...
      <div style={{ flex: 1, display: "flex", minHeight: 0 }}>
        <NavRail view={view} onView={onView} inRoom={inRoom} hasCampaigns={hasCampaigns}
          hasGalaxy={hasGalaxy} activeGame={activeGame} />

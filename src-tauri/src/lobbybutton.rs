...
//! used to be. `lobbybutton/mashiro_lobby_button.lua` puts a button back; this is
...
///
/// The widget spells this as `LuaUI/mashiro-lobby.txt`; the two have to agree,
/// which is what the test at the bottom of this file checks.
const SIGNAL: &str = "mashiro-lobby.txt";
...
const WIDGET_NAME: &str = "mashiro_lobby_button.lua";
...
pub fn place(root: &Path) {
    ...
    let lua = include_str!("lobbybutton/mashiro_lobby_button.lua");

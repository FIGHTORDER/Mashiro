...
const NOT_A_GAME_SETTING = {
  DisplayMode: "Mashiro manages its own window",
  LobbyDisplayMode: "Mashiro manages its own window",
  ActiveGraphicsLabel: "a text label, not a setting",
  TextToSpeech: "reads out lobby chat in Chobby; Mashiro has no equivalent",
};
